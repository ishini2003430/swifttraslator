...
```bash
git clone <https://github.com/ishini2003430/itpm_swifttranslator>
...
Test timeouts and settings can be modified in `playwright.config.ts`:
...
- All tests use the same base URL configured in `playwright.config.ts`
